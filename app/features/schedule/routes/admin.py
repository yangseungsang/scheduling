...
# ---------------------------------------------------------------------------
# Project reset (external API)
# ---------------------------------------------------------------------------

@admin_bp.route('/api/project-reset', methods=['POST'])
def api_project_reset():
    """Reset the entire project: clear tasks, blocks, and versions.

    Accepts optional JSON body:
      { "version_name": "v2.0.0", "version_description": "2차 통합시험" }
    If provided, creates a new single version after reset.
    """
