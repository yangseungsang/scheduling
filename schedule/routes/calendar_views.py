...
from schedule.helpers.overlap import compute_overlap_layout
from schedule.helpers.time_utils import generate_time_slots, is_break_slot
from schedule.models import location, schedule_block, settings, version
from schedule.routes.calendar_helpers import DAY_NAMES, get_current_version_id

schedule_bp = Blueprint('schedule', __name__, url_prefix='/schedule')


def _prepare_view_context(version_id):
...
def day_view():
    ...
    ctx = _prepare_view_context(version_id)
    ...
    return render_template(
        ...
        current_version_id=ctx['current_version_id'],
    )
