...
class TestTimeUtils:
    ...
    def test_minutes_to_time(self):
        from app.features.schedule.helpers.time_utils import minutes_to_time
        assert minutes_to_time(540) == '09:00'
        assert minutes_to_time(750) == '12:30'
        assert minutes_to_time(0) == '00:00'

    def test_time_roundtrip(self):
        from app.features.schedule.helpers.time_utils import time_to_minutes, minutes_to_time
        for t in ['00:00', '09:15', '12:45', '18:00', '23:30']:
            assert minutes_to_time(time_to_minutes(t)) == t

    def test_generate_time_slots(self):
        from app.features.schedule.helpers.time_utils import generate_time_slots
    ...
    def test_is_break_slot(self):
        from app.features.schedule.helpers.time_utils import is_break_slot
        settings = {
    ...
    def test_work_minutes_in_range_no_breaks(self):
        from app.features.schedule.helpers.time_utils import work_minutes_in_range
        settings = {
            'lunch_start': '12:00', 'lunch_end': '13:00',
            'breaks': [],
        }
    ...
    def test_adjust_end_for_breaks_no_break(self):
        from app.features.schedule.helpers.time_utils import adjust_end_for_breaks
        settings = {
            'work_end': '18:00',
            'lunch_start': '12:00', 'lunch_end': '13:00',
            'breaks': [],
    ...
    def test_get_break_periods(self):
        from app.features.schedule.helpers.time_utils import get_break_periods, time_to_minutes
        settings = {
            'lunch_start': '12:00', 'lunch_end': '13:00',
            'breaks': [
