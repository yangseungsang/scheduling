"""Tests for schedule time calculations."""


class TestTimeUtils:
    def test_time_to_minutes(self):
        from app.features.schedule.services.time import time_to_minutes
    ...
    def test_is_break_slot(self):
        from app.features.schedule.services.time import is_break_slot
        settings = {
    ...
    def test_work_minutes_in_range_no_breaks(self):
        from app.features.schedule.services.time import work_minutes_in_range
        settings = {
            'lunch_start': '12:00', 'lunch_end': '13:00',
            'breaks': [],
        }
    ...
    def test_adjust_end_for_breaks_no_break(self):
        from app.features.schedule.services.time import adjust_end_for_breaks
        settings = {
            'work_end': '18:00',
            'lunch_start': '12:00', 'lunch_end': '13:00',
            'breaks': [],
    ...
    def test_get_break_periods(self):
        from app.features.schedule.services.time import get_break_periods, time_to_minutes
        settings = {
            'lunch_start': '12:00', 'lunch_end': '13:00',
            'breaks': [
